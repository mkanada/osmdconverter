...
fieldFormalParameter
    : finalConstVarOrType? THIS_ dot identifier (formalParameterPart QU?)?
    | finalConstVarOrType? SUPER_ dot identifier (formalParameterPart QU?)?
    ;

fieldInitializer
    : (THIS_ dot)? identifier EQ initializerExpression
    ;
...
initializerListEntry
    : SUPER_ arguments
    | SUPER_ dot identifier arguments
    | fieldInitializer
    | assertion
    ;
...
redirection
    : CO THIS_ (dot identifier)? arguments
    ;
...
symbolLiteral
    : PO (identifier ( dot identifier)* | operator | VOID_)
    ;
