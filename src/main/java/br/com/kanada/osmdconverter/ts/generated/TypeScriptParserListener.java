...
public interface TypeScriptParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TypeScriptParser#declareModule}.
	 * @param ctx the parse tree
	 */
	void enterDeclareModule(TypeScriptParser.DeclareModuleContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeScriptParser#declareModule}.
	 * @param ctx the parse tree
	 */
	void exitDeclareModule(TypeScriptParser.DeclareModuleContext ctx);
	/**
	 * Enter a parse tree produced by {@link TypeScriptParser#namespaceElementList}.
	 * @param ctx the parse tree
	 */
	void enterNamespaceElementList(TypeScriptParser.NamespaceElementListContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeScriptParser#namespaceElementList}.
	 * @param ctx the parse tree
	 */
	void exitNamespaceElementList(TypeScriptParser.NamespaceElementListContext ctx);
	/**
	 * Enter a parse tree produced by {@link TypeScriptParser#namespaceElement}.
	 * @param ctx the parse tree
	 */
	void enterNamespaceElement(TypeScriptParser.NamespaceElementContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeScriptParser#namespaceElement}.
	 * @param ctx the parse tree
	 */
	void exitNamespaceElement(TypeScriptParser.NamespaceElementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code FunctionMethodProperty}
	 * labeled alternative in {@link TypeScriptParser#propertyAssignment}.
	 * @param ctx the parse tree
	 */
	void enterFunctionMethodProperty(TypeScriptParser.FunctionMethodPropertyContext ctx);
	/**
	 * Exit a parse tree produced by the {@code FunctionMethodProperty}
	 * labeled alternative in {@link TypeScriptParser#propertyAssignment}.
	 * @param ctx the parse tree
	 */
	void exitFunctionMethodProperty(TypeScriptParser.FunctionMethodPropertyContext ctx);
	/**
