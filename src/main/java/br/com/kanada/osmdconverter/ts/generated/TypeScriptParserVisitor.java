...
public interface TypeScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link TypeScriptParser#declareModule}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclareModule(TypeScriptParser.DeclareModuleContext ctx);
	/**
	 * Visit a parse tree produced by {@link TypeScriptParser#namespaceElementList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNamespaceElementList(TypeScriptParser.NamespaceElementListContext ctx);
	/**
	 * Visit a parse tree produced by {@link TypeScriptParser#namespaceElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNamespaceElement(TypeScriptParser.NamespaceElementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code FunctionMethodProperty}
	 * labeled alternative in {@link TypeScriptParser#propertyAssignment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionMethodProperty(TypeScriptParser.FunctionMethodPropertyContext ctx);
	/**
